...
This folder stores manual validation records for each user story and final checks.

- us1-landing-content.md
- us2-account-actions.md
- us3-category-navigation.md
