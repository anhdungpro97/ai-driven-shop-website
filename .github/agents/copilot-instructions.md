...
- JavaScript (ES Modules), React 18.3.x + `react`, `react-dom`, `prop-types`, `vite`, `@vitejs/plugin-react` (001-coffee-landing-page)
- N/A (static frontend content only) (001-coffee-landing-page)
- JavaScript (ES Modules) with ReactJS, HTML, CSS + `react`, `react-dom`, `prop-types`, `vite`, `@vitejs/plugin-react` (001-coffee-landing-page)
